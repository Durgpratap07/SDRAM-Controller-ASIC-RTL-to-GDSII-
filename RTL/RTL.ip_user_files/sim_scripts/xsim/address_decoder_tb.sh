...
#
# Script generated by Vivado on Fri Jul 24 01:12:21 +0530 2026
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : address_decoder_tb.sh
...
#
# Usage        : address_decoder_tb.sh
#                address_decoder_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                address_decoder_tb.sh [-reset_run]
#                address_decoder_tb.sh [-reset_log]
#                address_decoder_tb.sh [-help]
#
...
# script info
echo -e "address_decoder_tb.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./address_decoder_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot address_decoder_tb xil_defaultlib.address_decoder_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim address_decoder_tb -key {Behavioral:sim_1:Functional:address_decoder_tb} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/vivado/2025.1/Vivado/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb address_decoder_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./address_decoder_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: address_decoder_tb.sh [-help]\n\
Usage: address_decoder_tb.sh [-step]\n\
Usage: address_decoder_tb.sh [-lib_map_path]\n\
Usage: address_decoder_tb.sh [-reset_run]\n\
Usage: address_decoder_tb.sh [-reset_log]\n\
Usage: address_decoder_tb.sh [-keep_index]\n\
Usage: address_decoder_tb.sh [-noclean_files]\n\n\
