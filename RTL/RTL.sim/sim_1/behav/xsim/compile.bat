...
REM
REM Generated by Vivado on Wed Jul 29 00:03:27 +0530 2026
...
echo "xvlog --incr --relax -prj sdram_controller_tb_vlog.prj"
call xvlog  --incr --relax -prj sdram_controller_tb_vlog.prj -log xvlog.log
